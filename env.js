 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.travelBuddy.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.travelBuddy'; // ios bundle id
const PACKAGE = 'com.travelBuddy'; // android package name
const NAME = 'Travel Buddy'; // app name
const SLUG = 'travel-buddy'; // app slug
const SCHEME = 'travelBuddy'; // app scheme
